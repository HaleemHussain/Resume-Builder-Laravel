...
<body>
@include('partials.resumeBody')
</body>
<!-- Vendor JS Files -->
<script src="{{public_path('assets/vendor/purecounter/purecounter_vanilla.js')}}"></script>
...
<script src="{{public_path('assets/vendor/waypoints/noframework.waypoints.js')}}"></script>
